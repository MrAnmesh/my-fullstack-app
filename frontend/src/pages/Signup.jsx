  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <h2 style={{ color: '#0077b6', marginBottom: '1.5rem', fontWeight: 700 }}>Create Account</h2>
        <form onSubmit={handleSubmit} style={{ width: '100%' }}>
          ...
          <div style={{ marginBottom: '1.2rem' }}>
            <label htmlFor="username" style={{ fontWeight: 500, marginBottom: 6, display: 'block', color: '#333' }}>Username</label>
            <input
              type="text"
              name="username"
              value={username}
          ...
          <div style={{ textAlign: 'center', marginTop: 8 }}>
            <span style={{ color: '#666', fontSize: '0.97rem' }}>
              Already have an account? <Link to="/login" style={{ color: '#0077b6', textDecoration: 'underline', fontWeight: 500 }}>Login</Link>
            </span>
          </div>
        </form>
        <ToastContainer />
